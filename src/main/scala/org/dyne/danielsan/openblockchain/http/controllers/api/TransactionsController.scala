...
/**
  ...
  */
class TransactionsController (implicit val swagger: Swagger) extends ScalatraServlet with FutureSupport with JacksonJsonSupport with TransactionsControllerDocs {
